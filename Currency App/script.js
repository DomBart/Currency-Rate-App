...
const addCaret = document.getElementById("addcaret");
...
addCurrencyBtn.addEventListener("click", () => {
  ...
  if (addCurrencyBtn.classList.contains("open"))
    addCaret.className = "fas fa-caret-down";
  else addCaret.className = "fas fa-caret-up";
});
...
function populateCurrenciesList() {
  for (let i = 0; i < initialList.length; i++) {
    let currency = currencies.find((c) => c.abbreviation === initialList[i]);
      ...
      currency.abbreviation === baseCurrency ? "base-currency" : ""
          ...
          <div class="info">
            <p class="input">
              ...
              ><input type="text" placeholder="0.0000" value=${inputValue}>
            </p>
